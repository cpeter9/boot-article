...
\begin{figure}[h!]
<<fig_1, echo=FALSE, fig=TRUE, sanitize=TRUE, out.width='5in', out.height='5in', cache=TRUE>>=
library(ggplot2)
library(reshape2)
library(tikzDevice)
library(ggthemes)
...
\begin{figure}[h!]
<<type1error, echo=FALSE, fig=TRUE, sanitize=TRUE, out.width='6in', out.height='4.5in', warning=FALSE, cache=TRUE>>=
library(ggplot2)
library(reshape2)
library(tikzDevice)
