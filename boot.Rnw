...
\begin{align}
t &= \frac{\widebar{d} - D_0}{s_d/\sqrt{n}}
\end{align}

In this case, the interest lies with $\widebar{d}$ and whether it meets the normal distributional requirement.\\
